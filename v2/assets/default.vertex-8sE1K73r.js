import{t as e}from"./shaderStore-D-XQlhUT.js";import{a as t,c as ee,d as te,i as ne,l as re,n,o as ie,r as ae,s as oe,t as r,u as i}from"./vertexColorMixing-CBmtHj8r.js";import{a,i as o,n as s,r as c,t as se}from"./logDepthDeclaration-CLGvI4QS.js";import{t as ce}from"./helperFunctions-s1JcGifL.js";var l=`uvAttributeDeclaration`,u=`#if defined(UV{X}) && !defined(USE_VERTEX_PULLING)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=f);var ue={name:d,shader:f},p=`samplerVertexDeclaration`,m=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[g]||(e.IncludesShadersStoreWGSL[g]=_);var de={name:g,shader:_},v=`lightVxFragmentDeclaration`,y=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=y);var b={name:v,shader:y},x=`lightVxUboDeclaration`,S=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[C]||(e.IncludesShadersStoreWGSL[C]=w);var pe={name:C,shader:w},T=`morphTargetsVertexDeclaration`,E=`#ifdef MORPHTARGETS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[T]||(e.IncludesShadersStoreWGSL[T]=E);var me={name:T,shader:E},D=`vertexPullingDeclaration`,O=`#ifdef USE_VERTEX_PULLING
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[D]||(e.IncludesShadersStoreWGSL[D]=O);var k={name:D,shader:O},A=`vertexPullingVertex`,j=`#ifdef USE_VERTEX_PULLING
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[A]||(e.IncludesShadersStoreWGSL[A]=j);var M={name:A,shader:j},N=`morphTargetsVertexGlobal`,P=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
var vertexID : f32;
#endif
#endif
`;e.IncludesShadersStoreWGSL[N]||(e.IncludesShadersStoreWGSL[N]=P);var F={name:N,shader:P},I=`morphTargetsVertex`,L=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
#if {X}==0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[I]||(e.IncludesShadersStoreWGSL[I]=L);var R={name:I,shader:L},z=`prePassVertex`,B=`#ifdef PREPASS_DEPTH
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[z]||(e.IncludesShadersStoreWGSL[z]=B);var V={name:z,shader:B},H=`uvVariableDeclaration`,U=`#ifdef MAINUV{X}
#if !defined(UV{X})
...
#endif
`;e.IncludesShadersStoreWGSL[H]||(e.IncludesShadersStoreWGSL[H]=U);var he={name:H,shader:U},W=`samplerVertexImplementation`,G=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[W]||(e.IncludesShadersStoreWGSL[W]=G);var ge={name:W,shader:G},K=`bumpVertex`,q=`#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
#if defined(TANGENT) && defined(NORMAL)
var tbnNormal: vec3f=normalize(normalUpdated);var tbnTangent: vec3f=normalize(tangentUpdated.xyz);var tbnBitangent: vec3f=cross(tbnNormal,tbnTangent)*tangentUpdated.w;var matTemp= mat3x3f(finalWorld[0].xyz,finalWorld[1].xyz,finalWorld[2].xyz)* mat3x3f(tbnTangent,tbnBitangent,tbnNormal);vertexOutputs.vTBN0=matTemp[0];vertexOutputs.vTBN1=matTemp[1];vertexOutputs.vTBN2=matTemp[2];
#endif
#endif
`;e.IncludesShadersStoreWGSL[K]||(e.IncludesShadersStoreWGSL[K]=q);var _e={name:K,shader:q},J=`shadowsVertex`,Y=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[J]||(e.IncludesShadersStoreWGSL[J]=Y);var ve={name:J,shader:Y},X=`logDepthVertex`,Z=`#ifdef LOGARITHMICDEPTH
vertexOutputs.vFragmentDepth=1.0+vertexOutputs.position.w;vertexOutputs.position.z=log2(max(0.000001,vertexOutputs.vFragmentDepth))*uniforms.logarithmicDepthConstant;
#endif
`;e.IncludesShadersStoreWGSL[X]||(e.IncludesShadersStoreWGSL[X]=Z);var ye={name:X,shader:Z},Q=`defaultVertexShader`,$=`#include<defaultUboDeclaration>
...
`;e.ShadersStoreWGSL[Q]||(e.ShadersStoreWGSL[Q]=$);var be=[a,o,c,le,ce,te,i,oe,ue,s,h,de,re,ee,b,fe,pe,me,se,k,M,F,R,ie,t,ne,V,he,ge,_e,ae,n,ve,r,ye];for(let t of be)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var xe={name:Q,shader:$};export{xe as defaultVertexShaderWGSL};