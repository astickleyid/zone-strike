import{t as e}from"./shaderStore-D-XQlhUT.js";import{i as t,n as ee,r as te,t as n}from"./fogFragment-NFgubt9V.js";import{a as r,i as ne,n as re,r as ie,t as ae}from"./logDepthDeclaration-CLGvI4QS.js";import{t as oe}from"./helperFunctions-s1JcGifL.js";var i=`prePassDeclaration`,a=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=a);var o={name:i,shader:a},s=`oitDeclaration`,c=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=c);var se={name:s,shader:c},l=`lightUboDeclaration`,u=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=u);var ce={name:l,shader:u},d=`ltcHelperFunctions`,f=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=f);var le={name:d,shader:f},p=`clusteredLightingFunctions`,m=`struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=m);var ue={name:p,shader:m},h=`lightsFragmentFunctions`,g=`struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
#endif
...
return result;}
#endif
`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=g);var _={name:h,shader:g},v=`shadowsFragmentFunctions`,y=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=y);var b={name:v,shader:y},x=`samplerFragmentDeclaration`,S=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStoreWGSL[x]||(e.IncludesShadersStoreWGSL[x]=S);var de={name:x,shader:S},C=`fresnelFunction`,w=`#ifdef FRESNEL
fn computeFresnelTerm(viewDirection: vec3f,worldNormal: vec3f,bias: f32,power: f32)->f32
{let fresnelTerm: f32=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStoreWGSL[C]||(e.IncludesShadersStoreWGSL[C]=w);var fe={name:C,shader:w},T=`reflectionFunction`,E=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;e.IncludesShadersStoreWGSL[T]||(e.IncludesShadersStoreWGSL[T]=E);var pe={name:T,shader:E},D=`imageProcessingDeclaration`,O=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStoreWGSL[D]||(e.IncludesShadersStoreWGSL[D]=O);var k={name:D,shader:O},A=`imageProcessingFunctions`,j=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;e.IncludesShadersStoreWGSL[A]||(e.IncludesShadersStoreWGSL[A]=j);var me={name:A,shader:j},M=`textureRepetitionFunctions`,N=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStoreWGSL[M]||(e.IncludesShadersStoreWGSL[M]=N);var P={name:M,shader:N},F=`bumpFragmentMainFunctions`,I=`#ifndef TEXRD_DEFINED
fn TEXRD(t: texture_2d<f32>,ts: sampler,uv: vec2f)->vec4f {return textureSample(t,ts,uv);}
#define TEXRD_DEFINED
#endif
...
#endif
`;e.IncludesShadersStoreWGSL[F]||(e.IncludesShadersStoreWGSL[F]=I);var L={name:F,shader:I},R=`bumpFragmentFunctions`,z=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStoreWGSL[R]||(e.IncludesShadersStoreWGSL[R]=z);var he={name:R,shader:z},B=`bumpFragment`,V=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[B]||(e.IncludesShadersStoreWGSL[B]=V);var ge={name:B,shader:V},H=`decalFragment`,U=`#ifdef DECAL
...
#endif
`;e.IncludesShadersStoreWGSL[H]||(e.IncludesShadersStoreWGSL[H]=U);var _e={name:H,shader:U},W=`depthPrePass`,G=`#ifdef DEPTHPREPASS
#if !defined(PREPASS) && !defined(ORDER_INDEPENDENT_TRANSPARENCY)
fragmentOutputs.color= vec4f(0.,0.,0.,1.0);
#endif
return fragmentOutputs;
#endif
`;e.IncludesShadersStoreWGSL[W]||(e.IncludesShadersStoreWGSL[W]=G);var ve={name:W,shader:G},K=`lightFragment`,q=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[K]||(e.IncludesShadersStoreWGSL[K]=q);var ye={name:K,shader:q},J=`logDepthFragment`,Y=`#ifdef LOGARITHMICDEPTH
...
#endif
`;e.IncludesShadersStoreWGSL[X]||(e.IncludesShadersStoreWGSL[X]=Z);var xe={name:X,shader:Z},Q=`defaultPixelShader`,$=`#include<defaultUboDeclaration>
...
`;e.ShadersStoreWGSL[Q]||(e.ShadersStoreWGSL[Q]=$);var Se=[r,ne,ie,o,se,re,oe,ce,le,ue,_,b,de,fe,pe,k,me,P,L,he,t,ae,te,ee,ge,_e,ve,ye,be,n,xe];for(let t of Se)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var Ce={name:Q,shader:$};export{Ce as defaultPixelShaderWGSL};