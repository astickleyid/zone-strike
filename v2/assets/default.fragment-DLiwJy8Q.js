import{t as e}from"./shaderStore-D-XQlhUT.js";import{i as t,n as ee,r as te,t as ne}from"./fogFragment-WPqtYpyX.js";import{a as re,i as ie,n as ae,r as oe,t as se}from"./logDepthDeclaration-BKcd_JEL.js";import{t as ce}from"./helperFunctions-BXbvU0Ia.js";var n=`decalFragmentDeclaration`,r=`#ifdef DECAL
...
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=a);var ue={name:i,shader:a},o=`prePassDeclaration`,s=`#ifdef PREPASS
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=l);var fe={name:c,shader:l},u=`lightFragmentDeclaration`,d=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=d);var pe={name:u,shader:d},f=`lightUboDeclaration`,p=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=h);var g={name:m,shader:h},_=`clusteredLightingFunctions`,v=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=v);var he={name:_,shader:v},y=`lightsFragmentFunctions`,b=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
return result;}
#endif
`;e.IncludesShadersStore[y]||(e.IncludesShadersStore[y]=b);var ge={name:y,shader:b},x=`shadowsFragmentFunctions`,S=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[x]||(e.IncludesShadersStore[x]=S);var _e={name:x,shader:S},C=`samplerFragmentDeclaration`,w=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=w);var ve={name:C,shader:w},T=`fresnelFunction`,E=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=E);var ye={name:T,shader:E},D=`reflectionFunction`,O=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=O);var be={name:D,shader:O},k=`imageProcessingDeclaration`,A=`#ifdef EXPOSURE
...
return result;}`;e.IncludesShadersStore[j]||(e.IncludesShadersStore[j]=M);var N={name:j,shader:M},P=`textureRepetitionFunctions`,F=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStore[P]||(e.IncludesShadersStore[P]=F);var Se={name:P,shader:F},I=`bumpFragmentMainFunctions`,L=`#ifndef TEXRD_DEFINED
#define TEXRD(s,uv) texture2D(s,uv)
#define TEXRD_DEFINED
#endif
...
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=L);var Ce={name:I,shader:L},R=`bumpFragmentFunctions`,z=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=z);var we={name:R,shader:z},B=`bumpFragment`,V=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[B]||(e.IncludesShadersStore[B]=V);var Te={name:B,shader:V},H=`decalFragment`,U=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[H]||(e.IncludesShadersStore[H]=U);var Ee={name:H,shader:U},W=`depthPrePass`,G=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[W]||(e.IncludesShadersStore[W]=G);var De={name:W,shader:G},K=`lightFragment`,q=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[K]||(e.IncludesShadersStore[K]=q);var Oe={name:K,shader:q},J=`logDepthFragment`,Y=`#ifdef LOGARITHMICDEPTH
...
#endif
`;e.IncludesShadersStore[X]||(e.IncludesShadersStore[X]=Z);var Ae={name:X,shader:Z},Q=`defaultPixelShader`,$=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;e.ShadersStore[Q]||(e.ShadersStore[Q]=$);var je=[le,ue,re,ie,oe,de,fe,ae,ce,pe,me,g,he,ge,_e,ve,ye,be,xe,N,Se,Ce,we,t,se,te,ee,Te,Ee,De,Oe,ke,ne,Ae];for(let t of je)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var Me={name:Q,shader:$};export{Me as defaultPixelShader};