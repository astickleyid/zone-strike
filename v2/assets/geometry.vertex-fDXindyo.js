...
`;e.ShadersStore[S]||(e.ShadersStore[S]=C);var w=[n,s,u,f,t,v,l,x,a,h,d,p,r,o,i,c,m];for(let t of w)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var T={name:S,shader:C};export{T as geometryVertexShader};